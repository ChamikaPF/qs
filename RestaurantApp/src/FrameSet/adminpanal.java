...
import MyCodes.RestaurantManager;
...
public class adminpanal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/Add-Person.png"))); // NOI18N
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/Add-item.png"))); // NOI18N
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Food Items", "Customer Details", "Order Details", "purchas Details", "Suplier Details", " " }));
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/login.png"))); // NOI18N
        ...
        jButton8.setText("Make Purchase");
        ...
        jButton10.setText("System Login Record");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        rm.setEmpid((int) jSpinner1.getValue());
        rm.setUsername(jTextField1.getText());
        rm.setPassword(jTextField2.getText());
        rm.adduser();
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         ...
         int reply = JOptionPane.showConfirmDialog(null, "Are You Shure Do You Want To Add This Hall?","Confirmation", JOptionPane.YES_NO_OPTION);
        if (reply == JOptionPane.YES_OPTION)
        {
        RestaurantManager rm=new RestaurantManager();
        rm.setEmpid((int) jSpinner1.getValue());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
        RestaurantManager rm=new RestaurantManager();
        rm.setItemid((int) jSpinner2.getValue());
        rm.setItemname(jTextField3.getText());
        rm.setItemprice((int) jSpinner3.getValue());
        rm.setItemqunt((int) jSpinner4.getValue());
        rm.setItemtype((String) jComboBox1.getSelectedItem());
        rm.addfood(); 
        }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        rm.setResulttype(option);
        rm.showresult(jTable1);
